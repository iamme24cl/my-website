      ...
      <div className="w3-row-padding" style={{margin: "0 -16px"}}>
        <div className="w3-half w3-card-4">
          <div className="project-image-container">
            <a href="https://iamme24cl.github.io/expense-tracker-frontend/" target="_blank" rel="noreferrer"><img src="Screen Shot 2021-07-25 at 12.16.10 PM.png" style={{width: "100%"}} alt="expense-tracker" /></a>
          ...
          <hr style={{width: "100%"}} className="w3-opacity"/>
          <div className="project-image-container">
            <a href="https://www.youtube.com/watch?v=i3Q8Ns4z11o" target="_blank" rel="noreferrer"><img src="Screen Shot 2021-07-25 at 1.25.15 PM.png" style={{width: "100%"}} alt="recipe-manager" /></a>
            <div className="w3-container">
        ...
        <div className="w3-half w3-card-4">
          <div className="project-image-container">
            <a href="https://my-invoices.netlify.app/" target="_blank" rel="noreferrer"><img src="Screen Shot 2021-07-25 at 12.17.48 PM.png" style={{width: "100%"}} alt="invoices" /></a>
            <div className="w3-container">
          ...
          <hr style={{width: "100%"}} className="w3-opacity"/>
          <div className="project-image-container">
            <a href="https://www.youtube.com/watch?v=0dTVA8qC5XM" target="_blank" rel="noreferrer"><img src="Screen Shot 2021-07-25 at 1.32.21 PM.png" style={{width: "100%"}} alt="mero-wine-notes" /></a>
            <div className="w3-container">
