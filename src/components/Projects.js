...
const Projects = () => {
  return (
    <div className="w3-padding-16 w3-content" id="projects">
      ...
      <div className="w3-row-padding" style={{margin: "0 -16px"}}>
        <div className="w3-half w3-card-4">
          <a href="https://my-recipes-2020.herokuapp.com/" target="_blank" rel="noreferrer"><img className="project-image" src="images/recipes.gif" style={{width: "100%", height: "300px"}} alt="recipe-manager" /></a>
          <div className="w3-container">
